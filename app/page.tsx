...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      {/* Hero Section - AJUSTES DE QUEBRA E ESPAÇAMENTO MOBILE */}
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="space-y-3 md:space-y-6">
              ...
              {/* Ajuste: Novas quebras mobile e leading-tight para mobile */}
              <p className="text-lg md:text-4xl text-white leading-tight md:leading-snug"> {/* Alterado leading-relaxed para leading-tight */}
                Presentación revela cómo generar<br className="md:hidden" />
                {" "}entre 100 a 500 dólares al día con la<br className="md:hidden" />
                {" "}metodología de “Productos<br className="md:hidden" />
